...
#global constant value of umber of lines which can be bet on in slot machine
...
def deposit():
    ...
    return amount
#deposit function, user prompted to enter a number,if number is valid digit then converted to a int
#if valuye not grater than zero then if else statement checks
# is digit tells us if value entered by user is a whole number
...
def spin():
    ...
    print("You won on " + str(winning_lines))
